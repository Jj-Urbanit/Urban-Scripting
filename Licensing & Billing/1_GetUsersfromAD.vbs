...
If Not objConnection.State = adStateOpen Then
    wscript.echo "ERROR: Failed to create AD connection"
    wscript.quit
End If
...
' Check we have a result set to work with (avoid infinite loops)
'
If objRecordSet.EOF Then
  wscript.echo "Sorry, no records found. Please check your OU string!"
  wscript.quit
End If
...
wscript.echo "User list generated at " & Now & VBCrLf & "Reading Users from OU: " & strOU & VBCrLf & "Total user count: " & strCount & VBCrLf & VBCrLf & "User List:" & strEmailBody 
