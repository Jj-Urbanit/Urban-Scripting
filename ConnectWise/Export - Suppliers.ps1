...
$logpath = "D:\CW-Export-logs\Export-Suppliers.log"
$server = "localhost"
$database = "cwwebapp_themissinglink"
$query = "SELECT Company_Name FROM dbo.Company where Company_Status_RecID like '19'
