...
AND [cwwebapp_themissinglink].[dbo].[Company].[Company_Status_RecID] IN (1,9,18,22)
AND  [cwwebapp_themissinglink].[dbo].[Company].[Delete_Flag] = 0
ORDER BY [cwwebapp_themissinglink].[dbo].[Company].[Company_Name] ASC
"
# 1: Client (Active)
# 9: Client (Credit Hold)
# 13: Client (Unapproved)
# 18: Client (Special Info)
# 19: Supplier
# 21: Client (Inactive)
# 22: Client (COD)
# 23: Client (Poor Credit)
# 24: Client (Company Closed)
